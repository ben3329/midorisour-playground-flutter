...
import 'package:midorisour_playground_flutter/working_with_frontend/union/pages.dart';
...
final GoRouter onGenerateCustomRoute = GoRouter(
  routes: [
    ...
    GoRoute(
      ...
      builder: (context, state) => const CommonUnionPage(),
    ),
    GoRoute(
      path: '/working_with_frontend/union/unusual',
      builder: (context, state) => const UnusualUnionPage(),
    ),
    GoRoute(
